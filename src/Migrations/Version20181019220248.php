 ...
 */
final class Version20181019220248 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE movimientos_almacen (id INT AUTO_INCREMENT NOT NULL, id_producto_id INT NOT NULL, id_almacen_destino_id INT NOT NULL, id_almacen_origen_id INT NOT NULL, num_movimientos INT NOT NULL, cantidad INT NOT NULL, comentarion VARCHAR(255) NOT NULL, fecha DATE NOT NULL, INDEX IDX_9D44A9736E57A479 (id_producto_id), INDEX IDX_9D44A973F6A56F1 (id_almacen_destino_id), INDEX IDX_9D44A973C1344508 (id_almacen_origen_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE movimientos_almacen ADD CONSTRAINT FK_9D44A973F6A56F1 FOREIGN KEY (id_almacen_destino_id) REFERENCES almacen (id)');
        $this->addSql('ALTER TABLE movimientos_almacen ADD CONSTRAINT FK_9D44A973C1344508 FOREIGN KEY (id_almacen_origen_id) REFERENCES almacen (id)');
