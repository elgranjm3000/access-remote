...
class UserController extends AbstractController
{
...

    {
        ...
        return $this->render('user/index.html.twig', ['users' => $user1Repository->findAll()]);
    }
   ...
   /**
    ...
    {
        $form = $this->createForm(Userperfil1Type::class, $user);
        $form->handleRequest($request);
        ...
        return $this->render('user/editperfil.html.twig', [
            'user' => $user,
            'form' => $form->createView(),
        ]);
    }
