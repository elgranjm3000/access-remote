 ...
 */
class Ensamble extends \App\Entity\Ensamble implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Ensamble' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Ensamble' . "\0" . 'idproducto', '' . "\0" . 'App\\Entity\\Ensamble' . "\0" . 'cantidad', '' . "\0" . 'App\\Entity\\Ensamble' . "\0" . 'monto', '' . "\0" . 'App\\Entity\\Ensamble' . "\0" . 'productoadd', '' . "\0" . 'App\\Entity\\Ensamble' . "\0" . 'subtotal'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ensamble $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setIdproducto(?\App\Entity\Productos $idproducto): \App\Entity\Ensamble
    {
     ...
     * {@inheritDoc}
     */
    public function setCantidad(int $cantidad): \App\Entity\Ensamble
    {
     ...
     * {@inheritDoc}
     */
    public function setMonto(float $monto): \App\Entity\Ensamble
    {
     ...
     * {@inheritDoc}
     */
    public function addProducto(\App\Entity\Productos $producto): \App\Entity\Ensamble
    {
     ...
     * {@inheritDoc}
     */
    public function removeProducto(\App\Entity\Productos $producto): \App\Entity\Ensamble
    {
     ...
     * {@inheritDoc}
     */
    public function getProductoadd(): ?\App\Entity\Productos
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProductoadd', []);

        return parent::getProductoadd();
    }

    /**
     * {@inheritDoc}
     */
    public function setProductoadd(?\App\Entity\Productos $productoadd): \App\Entity\Ensamble
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProductoadd', [$productoadd]);

        return parent::setProductoadd($productoadd);
    }
     ...
     * {@inheritDoc}
     */
    public function setSubtotal(?float $subtotal): \App\Entity\Ensamble
    {
