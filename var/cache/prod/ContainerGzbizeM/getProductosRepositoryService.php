...
// Returns the private 'App\Repository\ProductosRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProductosRepository.php';

return $this->privates['App\Repository\ProductosRepository'] = new \App\Repository\ProductosRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
