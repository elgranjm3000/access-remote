...
// Returns the private 'App\Repository\MetasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MetasRepository.php';

return $this->privates['App\Repository\MetasRepository'] = new \App\Repository\MetasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
