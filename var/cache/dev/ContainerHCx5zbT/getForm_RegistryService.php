...
}, 'App\\Form\\Ensamble1Type' => function () {
    return ($this->privates['App\Form\Ensamble1Type'] ?? $this->privates['App\Form\Ensamble1Type'] = new \App\Form\Ensamble1Type());
}, 'App\\Form\\EnsambleType' => function () {
    return ($this->privates['App\Form\EnsambleType'] ?? $this->privates['App\Form\EnsambleType'] = new \App\Form\EnsambleType());
...
}, 'App\\Form\\MetasType' => function () {
    return ($this->privates['App\Form\MetasType'] ?? $this->privates['App\Form\MetasType'] = new \App\Form\MetasType());
...
}, 'App\\Form\\PresupuestoType' => function () {
    return ($this->privates['App\Form\PresupuestoType'] ?? $this->privates['App\Form\PresupuestoType'] = new \App\Form\PresupuestoType());
