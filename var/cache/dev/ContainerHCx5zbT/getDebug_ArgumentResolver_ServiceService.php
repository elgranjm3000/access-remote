...
return $this->privates['debug.argument_resolver.service'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Controller\\AlmacenController::delete' => function () {
    ...
    return ($this->privates['.service_locator.0fqA5K5'] ?? $this->load('get_ServiceLocator_0fqA5K5Service.php'));
}, 'App\\Controller\\FacturasController::cotizacion_pdf' => function () {
    return ($this->privates['.service_locator.fAmOCKw'] ?? $this->load('get_ServiceLocator_FAmOCKwService.php'));
}, 'App\\Controller\\FacturasController::cotizadorshow' => function () {
    ...
    return ($this->privates['.service_locator.2rCeHXu'] ?? $this->load('get_ServiceLocator_2rCeHXuService.php'));
}, 'App\\Controller\\FacturasController::editcotizador' => function () {
    return ($this->privates['.service_locator.2rCeHXu'] ?? $this->load('get_ServiceLocator_2rCeHXuService.php'));
}, 'App\\Controller\\FacturasController::factura_pdf' => function () {
    return ($this->privates['.service_locator.fAmOCKw'] ?? $this->load('get_ServiceLocator_FAmOCKwService.php'));
}, 'App\\Controller\\FacturasController::index' => function () {
    return ($this->privates['.service_locator.fAmOCKw'] ?? $this->load('get_ServiceLocator_FAmOCKwService.php'));
}, 'App\\Controller\\FacturasController::indexpresupuesto' => function () {
    return ($this->privates['.service_locator.fAmOCKw'] ?? $this->load('get_ServiceLocator_FAmOCKwService.php'));
}, 'App\\Controller\\FacturasController::new' => function () {
    return ($this->privates['.service_locator.k_WGrRw'] ?? $this->load('get_ServiceLocator_KWGrRwService.php'));
}, 'App\\Controller\\FacturasController::newpresupuesto' => function () {
    return ($this->privates['.service_locator.k_WGrRw'] ?? $this->load('get_ServiceLocator_KWGrRwService.php'));
    ...
    return ($this->privates['.service_locator.CFcHL19'] ?? $this->load('get_ServiceLocator_CFcHL19Service.php'));
...
}, 'App\\Controller\\IngresosController::new' => function () {
    return ($this->privates['.service_locator.k_WGrRw'] ?? $this->load('get_ServiceLocator_KWGrRwService.php'));
}, 'App\\Controller\\IngresosController::show' => function () {
    return ($this->privates['.service_locator.9Dq1.6i'] ?? $this->load('get_ServiceLocator_9Dq1_6iService.php'));
}, 'App\\Controller\\MetasController::delete' => function () {
    return ($this->privates['.service_locator.NWUTJ7c'] ?? $this->load('get_ServiceLocator_NWUTJ7cService.php'));
}, 'App\\Controller\\MetasController::edit' => function () {
    return ($this->privates['.service_locator.NWUTJ7c'] ?? $this->load('get_ServiceLocator_NWUTJ7cService.php'));
}, 'App\\Controller\\MetasController::graficos' => function () {
    return ($this->privates['.service_locator.I1IHNBi'] ?? $this->load('get_ServiceLocator_I1IHNBiService.php'));
}, 'App\\Controller\\MetasController::graficosganancias' => function () {
    return ($this->privates['.service_locator.I1IHNBi'] ?? $this->load('get_ServiceLocator_I1IHNBiService.php'));
}, 'App\\Controller\\MetasController::graficospromedios' => function () {
    return ($this->privates['.service_locator.I1IHNBi'] ?? $this->load('get_ServiceLocator_I1IHNBiService.php'));
}, 'App\\Controller\\MetasController::index' => function () {
    return ($this->privates['.service_locator.hJIExWB'] ?? $this->load('get_ServiceLocator_HJIExWBService.php'));
}, 'App\\Controller\\MetasController::show' => function () {
    return ($this->privates['.service_locator.NWUTJ7c'] ?? $this->load('get_ServiceLocator_NWUTJ7cService.php'));
    ...
    return ($this->privates['.service_locator.MpabvJx'] ?? $this->load('get_ServiceLocator_MpabvJxService.php'));
}, 'App\\Controller\\ProductosController::editensamble' => function () {
    return ($this->privates['.service_locator.MpabvJx'] ?? $this->load('get_ServiceLocator_MpabvJxService.php'));
    ...
    return ($this->privates['.service_locator.fAmOCKw'] ?? $this->load('get_ServiceLocator_FAmOCKwService.php'));
}, 'App\\Controller\\ReportesController::inventarios' => function () {
    return ($this->privates['.service_locator.kFI1I3_'] ?? $this->load('get_ServiceLocator_KFI1I3Service.php'));
    ...
    return ($this->privates['.service_locator.kFI1I3_'] ?? $this->load('get_ServiceLocator_KFI1I3Service.php'));
}, 'App\\Controller\\SecurityController::admin' => function () {
    return ($this->privates['.service_locator.VfVhme1'] ?? $this->load('get_ServiceLocator_VfVhme1Service.php'));
...
}, 'App\\Controller\\UserController::editperfil' => function () {
    return ($this->privates['.service_locator.qzh.j69'] ?? $this->load('get_ServiceLocator_Qzh_J69Service.php'));
