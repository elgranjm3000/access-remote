...
/* user/show.html.twig */
class __TwigTemplate_9088e87c9c3592ea719ca8cd692697cdc4717dae34ba0338056727b7afc22870 extends Twig_Template
{
    private $source;
    ...
    public function block_header($context, array $blocks = array())
    {
        ...
        echo "\">Listado de Usuarios</a></li>
              <li class=\"active\"><a href=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_edit", array("id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 20, $this->source); })()), "id", array()))), "html", null, true);
...
<div class=\"col-sm-12\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 52
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 52, $this->source); })()), "email", array()), "html", null, true);
        echo "</td>
            </tr>
...
";
    ...
    {
        return array (  194 => 71,  188 => 70,  184 => 68,  182 => 67,  179 => 66,  175 => 64,  173 => 63,  170 => 62,  166 => 60,  163 => 59,  159 => 58,  150 => 52,  143 => 48,  125 => 32,  116 => 31,  97 => 21,  93 => 20,  89 => 19,  73 => 5,  64 => 4,  46 => 3,  15 => 1,);
    }
...
{% block title %}Detalles de usuarios{% endblock %}
  {% block header %}
        ...
        <header id=\"topbar\" class=\"ph10\">
         ...
         <header id=\"topbar\" class=\"ph10\">
          <div class=\"topbar-left\">
            <ul class=\"nav nav-list nav-list-topbar pull-left\">
              <li class=\"active\"><a href=\"{{ path('user_new') }}\">Listado de Usuarios</a></li>
              <li class=\"active\"><a href=\"{{ path('user_edit', {'id': user.id}) }}\">Editar Usuario</a></li>
...
{% endblock %}
", "user/show.html.twig", "/var/www/html/access/templates/user/show.html.twig");
    }
}
