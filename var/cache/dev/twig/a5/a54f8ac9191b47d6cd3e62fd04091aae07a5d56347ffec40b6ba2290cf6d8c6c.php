...
class __TwigTemplate_875064c639c3085b1f20bf8f9e6fe51b1ab4b0c905e35f059a95383c7df70e7a extends Twig_Template
{
    private $source;
...
<div class=\"col-sm-12\">
        ...
        <tbody>
            <tr>
                ...
                <td>";
        // line 55
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["movimientos_deposito"]) || array_key_exists("movimientos_deposito", $context) ? $context["movimientos_deposito"] : (function () { throw new Twig_Error_Runtime('Variable "movimientos_deposito" does not exist.', 55, $this->source); })()), "id", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
...
{% endblock %}
", "movimientos_depositos/show.html.twig", "C:\\xampp\\htdocs\\access\\templates\\movimientos_depositos\\show.html.twig");
    }
}
