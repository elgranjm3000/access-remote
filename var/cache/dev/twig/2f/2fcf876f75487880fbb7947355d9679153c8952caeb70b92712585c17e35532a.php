...
class __TwigTemplate_87a5e4e9201737377d454fdfccd16b2b1cb6c92e93bd60bc6fb1b56ecb5bd1dd extends Twig_Template
{
    private $source;
...
<div class=\"col-sm-12\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 68
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["proveedore"]) || array_key_exists("proveedore", $context) ? $context["proveedore"] : (function () { throw new Twig_Error_Runtime('Variable "proveedore" does not exist.', 68, $this->source); })()), "telefonoParticular", array()), "html", null, true);
        echo "</td>
            </tr>
                        </tbody>
                      </table>
