...
/* user/edit.html.twig */
class __TwigTemplate_966bf5efd597336c1d234e2f9b17ec5b21ac379d885034650e1245dd37d9d0db extends Twig_Template
{
    private $source;
...
";
    ...
    {
        return array (  131 => 38,  128 => 37,  119 => 36,  96 => 22,  92 => 21,  80 => 12,  73 => 7,  64 => 6,  46 => 3,  15 => 1,);
    }
...
{% block header %}
 ...
 <header id=\"topbar\" class=\"ph10\">
             ...
             <div class=\"topbar-left\">
            <ol class=\"breadcrumb\">
              <li class=\"crumb-active\"><a href=\"{{ path('user_index') }}\">Usuarios</a></li>                            
              <li class=\"crumb-trail\">Editar registro</li>
            </ol>
          </div>
         ...
         <header id=\"topbar\" class=\"ph10\">
          <div class=\"topbar-left\">
            <ul class=\"nav nav-list nav-list-topbar pull-left\">
              <li class=\"active\"><a href=\"{{ path('user_index') }}\">Listado de Usuarios</a></li>
...
{% endblock %}
", "user/edit.html.twig", "C:\\xampp\\htdocs\\access\\templates\\user\\edit.html.twig");
    }
}
