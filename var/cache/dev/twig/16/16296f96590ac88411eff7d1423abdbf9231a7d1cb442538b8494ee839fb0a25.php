...
class __TwigTemplate_6ae473f951392ae89641b2ac38bc960db9376772a19f6668080764b93fc7bd3b extends Twig_Template
{
    private $source;
                        ...
                        <div class=\"col-md-4\">
                          <div class=\"section\">
                            <label class=\"field\">
                              ";
        // line 34
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 34, $this->source); })()), "monto", array()), 'widget', array("attr" => array("class" => "gui-input", "placeholder" => "monto")));
        echo "
...
\t\t        \t <div class=\"row\">
                        ...
                        <div class=\"col-md-4\">
                          <div class=\"section\">
                            <label class=\"field\">
                              {{ form_widget(form.monto, {'attr': {'class': 'gui-input','placeholder':\"monto\" }}) }}
