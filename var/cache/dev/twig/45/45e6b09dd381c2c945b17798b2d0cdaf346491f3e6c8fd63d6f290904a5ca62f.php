...
";
   ...
   <table class=\"table table-bordered mbn footable\" id=\"example\">
        <thead>
            <tr>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["clientes"]) || array_key_exists("clientes", $context) ? $context["clientes"] : (function () { throw new Twig_Error_Runtime('Variable "clientes" does not exist.', 68, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cliente"]) {
            ...
            echo "\"><span class=\"glyphicon glyphicon-tasks \"></span></a>
                    ...
                    <a data-toggle=\"tooltip\" title=\"Crear Cotizacion\" href=\"";
            // line 88
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("presupuesto_new", array("cliente" => twig_get_attribute($this->env, $this->source, $context["cliente"], "id", array()))), "html", null, true);
            echo "\"><span class=\" glyphicon glyphicon-subtitles\"></span></a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  244 => 96,  235 => 92,  226 => 88,  221 => 86,  217 => 85,  213 => 84,  208 => 82,  204 => 81,  200 => 80,  196 => 79,  192 => 78,  188 => 77,  184 => 76,  180 => 75,  176 => 74,  172 => 73,  168 => 72,  164 => 71,  160 => 69,  155 => 68,  117 => 32,  108 => 31,  89 => 20,  73 => 6,  64 => 5,  46 => 3,  15 => 1,);
    }
        ...
        {% for cliente in clientes %}
            <tr>
                ...
                <td>
                    ...
                    <a data-toggle=\"tooltip\" title=\"Crear Cotizacion\" href=\"{{ path('presupuesto_new', {'cliente': cliente.id}) }}\"><span class=\" glyphicon glyphicon-subtitles\"></span></a>
                </td>
            </tr>
        {% else %}
            <tr>
