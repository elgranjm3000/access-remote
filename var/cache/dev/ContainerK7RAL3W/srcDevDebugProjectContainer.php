...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            'App\\Controller\\AlmacenController' => 'getAlmacenControllerService.php',
            'App\\Controller\\ClientesController' => 'getClientesControllerService.php',
            'App\\Controller\\DefaultController' => 'getDefaultControllerService.php',
            'App\\Controller\\DescuentoController' => 'getDescuentoControllerService.php',
            'App\\Controller\\DetallesFacturaController' => 'getDetallesFacturaControllerService.php',
            'App\\Controller\\FacturasController' => 'getFacturasControllerService.php',
            'App\\Controller\\FamiliaController' => 'getFamiliaControllerService.php',
            'App\\Controller\\HomeController' => 'getHomeControllerService.php',
            'App\\Controller\\IngresosController' => 'getIngresosControllerService.php',
            'App\\Controller\\MetasController' => 'getMetasControllerService.php',
            'App\\Controller\\MovimientosAlmacenController' => 'getMovimientosAlmacenControllerService.php',
            'App\\Controller\\MovimientosDepositosController' => 'getMovimientosDepositosControllerService.php',
            'App\\Controller\\ProductosController' => 'getProductosControllerService.php',
            'App\\Controller\\ProveedoresController' => 'getProveedoresControllerService.php',
            'App\\Controller\\RegistrationController' => 'getRegistrationControllerService.php',
            'App\\Controller\\ReportesController' => 'getReportesControllerService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('wtqV4V6Jw7', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L5RkSTOnId', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($a, array('default_path' => ($this->targetDirs[3].'/templates'), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception::showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $c = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\EmptyVersionStrategy(), new \Symfony\Component\Asset\Context\RequestStackContext($d, '', false)), array());
        ...
        $instance->addExtension(new \App\Twig\AppExtension(($this->services['doctrine'] ?? $this->getDoctrineService())));
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension($g));
        $instance->addExtension(new \FOS\CKEditorBundle\Twig\CKEditorExtension(new \FOS\CKEditorBundle\Renderer\CKEditorRenderer(new \FOS\CKEditorBundle\Builder\JsonBuilder(($this->privates['property_accessor'] ?? $this->getPropertyAccessorService())), $f, $c, $d, (($this->has("twig")) ? ($this->get("twig")) : ($this->get("templating"))), (($this->hasParameter("locale")) ? ($this->getParameter("locale")) : (null)))));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ty+akwbeY2', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('evs4aa49ZE', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MAY8qW04oD', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LQShedDBTh', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'brochures_directory': $value = ($this->targetDirs[3].'/uploads/brochures'); break;
            ...
            case 'white_october_tcpdf.file': $value = ($this->targetDirs[3].'/src/../vendor/tecnickcom/tcpdf/tcpdf.php'); break;
            case 'white_october_tcpdf.tcpdf': $value = array(
                'k_tcpdf_external_config' => false,
                'k_path_url' => ($this->targetDirs[3].'/src/../vendor/tecnickcom/tcpdf/'),
                'k_path_main' => ($this->targetDirs[3].'/src/../vendor/tecnickcom/tcpdf/'),
                'k_path_fonts' => ($this->targetDirs[3].'/src/../vendor/tecnickcom/tcpdf/fonts/'),
                'k_path_cache' => ($this->targetDirs[0].'/tcpdf'),
                'k_path_url_cache' => ($this->targetDirs[0].'/tcpdf'),
                'k_path_images' => ($this->targetDirs[3].'/src/../vendor/tecnickcom/tcpdf/examples/images/'),
                'k_blank_image' => ($this->targetDirs[3].'/src/../vendor/tecnickcom/tcpdf/examples/images/_blank.png'),
