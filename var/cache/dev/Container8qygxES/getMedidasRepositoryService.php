...
// Returns the private 'App\Repository\MedidasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MedidasRepository.php';

return $this->privates['App\Repository\MedidasRepository'] = new \App\Repository\MedidasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
