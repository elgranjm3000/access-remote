...
// Returns the private 'App\Repository\FechaNacimientoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FechaNacimientoRepository.php';

return $this->privates['App\Repository\FechaNacimientoRepository'] = new \App\Repository\FechaNacimientoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
