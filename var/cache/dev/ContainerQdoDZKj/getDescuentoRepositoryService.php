...
// Returns the private 'App\Repository\DescuentoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DescuentoRepository.php';

return $this->privates['App\Repository\DescuentoRepository'] = new \App\Repository\DescuentoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
