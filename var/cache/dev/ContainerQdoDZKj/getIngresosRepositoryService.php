...
// Returns the private 'App\Repository\IngresosRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\IngresosRepository.php';

return $this->privates['App\Repository\IngresosRepository'] = new \App\Repository\IngresosRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
