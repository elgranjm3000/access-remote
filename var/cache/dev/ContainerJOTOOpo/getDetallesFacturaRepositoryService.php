...
// Returns the private 'App\Repository\DetallesFacturaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DetallesFacturaRepository.php';

return $this->privates['App\Repository\DetallesFacturaRepository'] = new \App\Repository\DetallesFacturaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
