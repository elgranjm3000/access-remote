...
// Returns the private 'App\Repository\ServiciosRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ServiciosRepository.php';

return $this->privates['App\Repository\ServiciosRepository'] = new \App\Repository\ServiciosRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
