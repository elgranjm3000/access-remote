...
// Returns the private 'App\Repository\ProveedoresRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProveedoresRepository.php';

return $this->privates['App\Repository\ProveedoresRepository'] = new \App\Repository\ProveedoresRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
