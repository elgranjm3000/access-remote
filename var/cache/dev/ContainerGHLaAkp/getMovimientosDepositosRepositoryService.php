...
// Returns the private 'App\Repository\MovimientosDepositosRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MovimientosDepositosRepository.php';

return $this->privates['App\Repository\MovimientosDepositosRepository'] = new \App\Repository\MovimientosDepositosRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
