...
// Returns the private 'App\Repository\AlmacenRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AlmacenRepository.php';

return $this->privates['App\Repository\AlmacenRepository'] = new \App\Repository\AlmacenRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
