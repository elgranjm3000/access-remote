...
// Returns the private 'App\Repository\FacturasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FacturasRepository.php';

return $this->privates['App\Repository\FacturasRepository'] = new \App\Repository\FacturasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
