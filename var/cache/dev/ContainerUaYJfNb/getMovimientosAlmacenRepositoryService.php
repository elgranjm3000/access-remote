...
// Returns the private 'App\Repository\MovimientosAlmacenRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MovimientosAlmacenRepository.php';

return $this->privates['App\Repository\MovimientosAlmacenRepository'] = new \App\Repository\MovimientosAlmacenRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
