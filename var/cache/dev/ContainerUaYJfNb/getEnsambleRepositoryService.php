...
// Returns the private 'App\Repository\EnsambleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EnsambleRepository.php';

return $this->privates['App\Repository\EnsambleRepository'] = new \App\Repository\EnsambleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
