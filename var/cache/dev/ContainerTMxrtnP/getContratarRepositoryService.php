...
// Returns the private 'App\Repository\ContratarRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ContratarRepository.php';

return $this->privates['App\Repository\ContratarRepository'] = new \App\Repository\ContratarRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
