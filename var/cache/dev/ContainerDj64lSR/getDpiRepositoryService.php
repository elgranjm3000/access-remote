...
// Returns the private 'App\Repository\DpiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DpiRepository.php';

return $this->privates['App\Repository\DpiRepository'] = new \App\Repository\DpiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
