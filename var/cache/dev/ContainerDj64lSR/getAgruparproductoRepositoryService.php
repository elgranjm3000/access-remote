...
// Returns the private 'App\Repository\AgruparproductoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AgruparproductoRepository.php';

return $this->privates['App\Repository\AgruparproductoRepository'] = new \App\Repository\AgruparproductoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
