...
// Returns the private 'App\Repository\FamiliaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FamiliaRepository.php';

return $this->privates['App\Repository\FamiliaRepository'] = new \App\Repository\FamiliaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
