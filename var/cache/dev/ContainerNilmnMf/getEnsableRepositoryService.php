...
// Returns the private 'App\Repository\EnsableRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EnsableRepository.php';

return $this->privates['App\Repository\EnsableRepository'] = new \App\Repository\EnsableRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
