...
// Returns the private 'App\Repository\User1Repository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\User1Repository.php';

return $this->privates['App\Repository\User1Repository'] = new \App\Repository\User1Repository(($this->services['doctrine'] ?? $this->getDoctrineService()));
