...
class __TwigTemplate_5f5b964ed34df62de11269ed008ab32fb078f037654ada7039cde5c9d66ed43e extends Twig_Template
{
    private $source;
                        ...
                        <div class=\"col-md-4\">
                          <div class=\"section\">
                            <label class=\"field\">
                              ";
        // line 50
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 50, $this->source); })()), "correo", array()), 'widget', array("attr" => array("class" => "gui-input", "placeholder" => "Correo electronico")));
        echo "
...
\t\t        \t <div class=\"row\">
                      ...
                      <div class=\"row\">
                        ...
                        <div class=\"col-md-4\">
                          <div class=\"section\">
                            <label class=\"field\">
                              {{ form_widget(form.correo, {'attr': {'class': 'gui-input','placeholder':\"Correo electronico\"}}) }}
...
</div>", "proveedores/_form.html.twig", "C:\\xampp\\htdocs\\access\\templates\\proveedores\\_form.html.twig");
    }
}
